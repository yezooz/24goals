...
if __name__ == '__main__':
    ...
    dates = ("20080101", "20080106")
    # get.get_and_save_whole_league(path)

    for d in dates:
        path = "http://soccernet-akamai.espn.go.com/scoreboard?league=%s&date=%s&refresh=45&cc=5739" % (league, d)
        print path
        get.get_and_save_page(path, True)  # True - do update score
