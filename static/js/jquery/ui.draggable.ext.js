...
//----------------------------------------------------------------
    ...
    $.ui.plugin.add("draggable", "stop", "revert", function (e, ui) {
        ...
        $(ui.helper).animate({
            ...
            if (self.helper != self.element) window.setTimeout(function () {
                $(self.helper).remove();
            }, 0); //Using setTimeout because of strange flickering in Firefox
...
//----------------------------------------------------------------
    ...
    $.ui.plugin.add("draggable", "stop", "iframeFix", function (e, ui) {
        if (ui.options.iframeFix) $("div.DragDropIframeFix").each(function () {
